...
import { buildMigrator, defaultConfig, Migrator, PartialConfigInterface, State } from '@betagouvpdc/evolution-geo';
import { hash } from '@betagouvpdc/evolution-geo/dist/helpers';
...
async function main(): Promise<void> {
  ...
  command
    .name('ExternalData')
    .description('Importe les datasets de données externes nécessairent à l\'observatoire')
