 SELECT date_trunc('week'::text, (cc.datetime AT TIME ZONE 'Europe/Paris'::text)) AS week,
  ...
  WHERE cc.journey_type = 'short'::cee.journey_type_enum AND date_trunc('week'::text, (cc.datetime AT TIME ZONE 'Europe/Paris'::text)) < (CURRENT_TIMESTAMP - '7 days'::interval)
