      ...
      <nav role="navigation" className={fr.cx('fr-pagination')} aria-label="Pagination">
        <ul className={fr.cx('fr-pagination__list')}>
          <li>
            ...
            {defaultPage > 1 &&
              <Link className={fr.cx('fr-pagination__link', 'fr-pagination__link--first')} href='' onClick={() => props.onChange(1)}>
              Première page
            </Link>
            }
          </li>
          <li>
            ...
            {defaultPage > 1 &&
              <Link className={fr.cx('fr-pagination__link', 'fr-pagination__link--prev', 'fr-pagination__link--lg-label')} 
                href='' onClick={() => props.onChange(defaultPage-1)}
              >
                Page précédente
              </Link>
            }
            ...
            <li key={p.number}>
              ...
              {!p.active &&
                <Link className={fr.cx('fr-pagination__link')} 
                  href='' onClick={() => props.onChange(p.number)}
                >
                  {p.number}
                </Link>
              }
          ...
          <li>
            ...
            {defaultPage != props.count &&
              <Link className={fr.cx('fr-pagination__link', 'fr-pagination__link--last')} 
                href='' onClick={() => props.onChange(props.count)}
              >
                Dernière page
              </Link>
            }
