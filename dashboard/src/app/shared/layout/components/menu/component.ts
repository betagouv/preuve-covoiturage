    ...
    this.items = [
      {
        ...
        items: [
          ...
          },
          {
            ...
            routerLink: '/dashboard/operators/journey-import',
          ...
          },
          {
            label: 'Import',
            icon: 'pi pi-fw pi-upload',
            routerLink: '/dashboard/registry/journey-import',
            routerLinkActive: 'is-active',
          ...
          },
          {
            ...
            routerLink: '/dashboard/aoms/statistics',
            routerLinkActive: 'is-active',
        ...
        items: [
          {
            ...
            routerLink: '/dashboard/operators/tokens',
            routerLinkActiveOptions: { exact: true },
            visible: this.hasAnyGroup(['operators']),
          },
          {
            label: 'Visibilité AOM',
            icon: 'pi pi-fw pi-cog',
            routerLink: '/dashboard/operators/aom-visibility',
            routerLinkActiveOptions: { exact: true },
            visible: this.hasAnyGroup(['operators']),
          },
          {
          ...
          },
          {
            ...
            routerLink: '/dashboard/operators/admin',
            routerLinkActive: 'is-active',
            visible: this.hasAnyGroup(['registry']),
          },
          {
            ...
            routerLink: '/dashboard/aoms/admin',
            routerLinkActive: 'is-active',
            visible: this.hasAnyGroup(['registry']),
          },
        ],
