...
export class JsonRpcCrudService<ListEntityT extends IModel, EntityT extends IModel> extends JsonRPC {
  constructor(http: HttpClient, router: Router, activedRoute: ActivatedRoute, protected method: string, url?: string) {
    super(http, router, activedRoute, url);
  }
  ...
  getById(id: string): Observable<EntityT> {
