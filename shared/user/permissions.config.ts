...
const permissions = {
  ...
  'policy.find': ['territory.demo', 'territory.user', 'territory.admin', 'registry.user', 'registry.admin'],
  ...
  'territory.find': ['common', 'territory.demo', 'territory.user', 'territory.admin', 'registry.user', 'registry.admin'],
  ...
  'trip.export': ['operator.user','operator.admin', 'territory.user','territory.admin', 'registry.user', 'registry.admin'],
  'trip.list': ['operator.user','operator.admin', 'territory.demo', 'territory.user','territory.admin', 'registry.user', 'registry.admin'],
