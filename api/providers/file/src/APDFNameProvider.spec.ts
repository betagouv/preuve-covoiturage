...
test('Stringify APDF: filename', (t) => {
  ...
  t.is(
    ...
    'APDF-2022-01-1-2-111-22200-yolo.xlsx',
  );
});
...
test('Stringify APDF: filename null trips and amount', (t) => {
  ...
  t.is(
    ...
    path.join(os.tmpdir(), 'APDF-2022-01-1-2-0-0-yolo.xlsx'),
  );
});
...
test('Stringify APDF: filename rounded amount', (t) => {
  ...
  t.is(
    ...
    path.join(os.tmpdir(), 'APDF-2022-01-1-2-111-22299-yolo.xlsx'),
  );
});
...
test('Stringify APDF: filepath with object', (t) => {
  ...
  t.is(
    ...
    path.join(os.tmpdir(), 'APDF-2022-01-1-2-111-22200-yolo.xlsx'),
  );
});

test('Parse APDF: filename', (t) => {
  const provider = new APDFNameProvider();
  t.deepEqual(provider.parse('APDF-2022-01-1-2-111-22200-abc123.xlsx'), {
    name: 'abc123',
    datetime: new Date('2022-01-01T00:00:00Z'),
    campaign_id: 1,
    operator_id: 2,
...
test('Parse APDF: filename with prefix', (t) => {
  const provider = new APDFNameProvider();
  t.deepEqual(provider.parse('1/APDF-2022-01-1-2-111-22200-abc123.xlsx'), {
    name: 'abc123',
    datetime: new Date('2022-01-01T00:00:00Z'),
    campaign_id: 1,
    operator_id: 2,
