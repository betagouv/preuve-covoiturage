...
async function macro(t: ExecutionContext<TestContext>, input: {[k: string]: any}, result: boolean | string, schema: {[k: string]: any}, ...extraSchemas: {[k: string]: any}[]) { 
  ...
  if (typeof result === 'string') {
    await t.throwsAsync(
      t.context.provider.validate(input),
...
test('should raise exception if data is invalid', macro, { hello: 1 }, '[{"keyword":"type","dataPath":".hello","schemaPath":"#/properties/hello/type","params":{"type":"string"},"message":"should be string"}]', {
      $schema: 'http://json-schema.org/draft-07/schema#',
      $id: 'myschema',
      type: 'object',
      properties: {
...
test('should works with ref', macro, { hello: { world: '!!!' } }, true, {
  $schema: 'http://json-schema.org/draft-07/schema#',
  $id: 'myschema',
  type: 'object',
  properties: {
