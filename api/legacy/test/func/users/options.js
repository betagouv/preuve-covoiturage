...
describe('User options', () => {
  it('GET /users/:id/options :: list options', async () =>
    request
  ...
  it('POST /users/:id/options :: create option', async () =>
    request
  ...
  it('GET /users/:id/options/option-name :: read option', async () =>
    request
  ...
  it('DELETE /users/:id/options/option-name :: delete option', async () =>
    request
