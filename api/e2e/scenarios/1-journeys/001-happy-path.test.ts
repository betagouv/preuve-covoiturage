import { beforeEach, describe } from "dep:testing-bdd";
...
describe("Journey creation", () => {
  ...
  //   const journey = await createOperatorJourney();
  //   const response = await http.post("/v3/journeys", JSON.stringify(journey));
  //   console.log(response.body);
  //   expect(response.status).toEqual(201);
  //   expect(response.body).toBeDefined();
  //   // expect(response.body.operator_journey_id).toEqual(journey.operator_journey_id);
  // });
});
