...
export interface TripRepositoryProviderInterface extends ParentRepositoryProviderInterface {
...
export abstract class TripRepositoryProviderInterfaceResolver extends ParentRepositoryProviderInterfaceResolver {
