...
//   describe('Process - new Trip from journey', () => {
//     before(async () => {
//       processParams = {
//         journey: {
//           ...journey,
...
//         expect(data.result.territories).to.eql(trip.territories);
...
//   let newJourney;
//   describe('Process - consolidate trip with journey', () => {
//     before(async () => {
//       newJourney = {
//         ...secondJourney,
//         passenger: {
...
//       expect(data.result.territories).to.eql([...trip.territories, secondJourney.passenger.end.territory[0]]);
...
//       // check consolidation ot territories
//       expect(data.result.territories).to.eql([...trip.territories, secondJourney.passenger.end.territories[0]]);
