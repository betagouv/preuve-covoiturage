...
export class BuildExportAction extends Action {
  ...
  public readonly financialFields = [
    ...
    'passenger_incentive_${i+1}_siret',
    'passenger_incentive_${i+1}_amount',
    ...
    'passenger_incentive_rpc_${i+1}_siret',
    'passenger_incentive_rpc_${i+1}_amount',
    ...
    'driver_id',
    'driver_revenue',
    'driver_incentive_${i+1}_siret',
    'driver_incentive_${i+1}_amount',
    ...
    'driver_incentive_rpc_${i+1}_siret',
    'driver_incentive_rpc_${i+1}_amount',
