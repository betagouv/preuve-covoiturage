...
import { handlerConfig, ParamsInterface, ResultInterface } from '../shared/acquisition/summaryerrors.contract';
import { alias } from '../shared/acquisition/summaryerrors.schema';
...
export class SummaryErrorAction extends AbstractAction {
