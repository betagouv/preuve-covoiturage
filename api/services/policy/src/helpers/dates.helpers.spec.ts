...
import { castUserStringToUTC, toISOString, toTzString, today } from './dates.helper';
...
test('full form Europe/Paris', (t) => {
  ...
  t.deepEqual(castUserStringToUTC('Europe/Paris', ['2023-01-01T00:00:00+0100']).map(toTzString), [
...
test('short form Europe/Paris - add/sub days', (t) => {
  ...
  t.is(toISOString(start), '2022-12-31T23:00:00.000Z');
  t.is(toTzString(start), '2023-01-01T00:00:00+0100');

  t.is(toISOString(addDays(start, 7)), '2023-01-07T23:00:00.000Z');
  t.is(toTzString(addDays(start, 7)), '2023-01-08T00:00:00+0100');

  t.is(toISOString(subDays(start, 7)), '2022-12-24T23:00:00.000Z');
  t.is(toTzString(subDays(start, 7)), '2022-12-25T00:00:00+0100');
});
...
test('short form Europe/Paris - add months', (t) => {
  ...
  t.is(toISOString(addMonths(start, 5)), '2023-05-31T22:00:00.000Z');
  t.is(toTzString(addMonths(start, 5)), '2023-06-01T00:00:00+0200');

  t.is(toISOString(addMonths(start, 12)), '2023-12-31T23:00:00.000Z');
  t.is(toTzString(addMonths(start, 12)), '2024-01-01T00:00:00+0100');
});
...
test('short form Europe/Paris - startOfMonth 01/01', (t) => {
  ...
  t.is(toISOString(startOfMonth(start)), '2022-12-31T23:00:00.000Z');
  t.is(toTzString(startOfMonth(start)), '2023-01-01T00:00:00+0100');
});
...
test('short form Europe/Paris - startOfMonth 05/01', (t) => {
  ...
  t.is(toTzString(start), '2023-01-05T00:00:00+0100');
...
test('short form Europe/Paris - next startOfMonth 05/01', (t) => {
  ...
  t.is(toISOString(addMonths(startOfMonth(start), 1)), '2023-01-31T23:00:00.000Z');
  t.is(toTzString(addMonths(startOfMonth(start), 1)), '2023-02-01T00:00:00+0100');
});
