...
// export class IdfmRegular extends SetterRule<IdfmParametersInterface> {
...
//       throw new NotApplicableTargetException(IdfmRegular);
//     }
...
//           !(this.parameters.paris_insee_code.indexOf(p.start_insee) >= 0 && this.parameters.paris_insee_code.indexOf(p.end_insee) >= 0),
