...
//   period: string;
// }
// export class MaxAmountPerTargetRestriction extends FilterRule<MaxAmountParameters> {
...
//     const key = `${MaxAmountPerTargetRestriction.slug}.${ctx.person.identity_uuid}.${this.parameters.period}.${keyPeriod}`;
