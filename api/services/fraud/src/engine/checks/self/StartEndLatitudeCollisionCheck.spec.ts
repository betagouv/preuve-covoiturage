...
test('max', range, { driver_start_lat: 48.847218, driver_end_lat: 48.847218 }, 100, 100);
test('min', range, { driver_start_lat: 48.847218, driver_end_lat: 49.857218 }, 0, 0);
test('between', range, { driver_start_lat: 48.847218, driver_end_lat: 48.848218 }, 0, 100);
