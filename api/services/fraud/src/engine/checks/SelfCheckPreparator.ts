    ...
    const query = {
      text: `
        SELECT
          ...
          driver.start_geo_code as driver_start_geo_code,
          driver.end_geo_code as driver_end_geo_code,
          ...
          passenger.start_geo_code as passenger_start_geo_code,
          passenger.end_geo_code as passenger_end_geo_code,
