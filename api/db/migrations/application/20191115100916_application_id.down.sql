...
INSERT INTO application.applications_new (_id, created_at, deleted_at, name, owner_id, owner_service, permissions)
SELECT uuid::uuid, created_at, deleted_at, name, owner_id, owner_service, permissions
