...
(
  ...
  driver_travel_pass_name VARCHAR(32),
  driver_travel_pass_user_id VARCHAR(128),
  ...
  passenger_travel_pass_name VARCHAR(32),
  passenger_travel_pass_user_id VARCHAR(128),
