...
CREATE UNIQUE INDEX fraudcheck.phone_insights on('phone_trunc', 'departure_date', 'end_date');
...
CREATE UNIQUE INDEX fraudcheck.potential_triangular_patterns on('id', 'group', 'phone_trunc');
