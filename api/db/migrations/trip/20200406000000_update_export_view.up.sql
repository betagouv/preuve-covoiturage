...
CREATE MATERIALIZED VIEW trip.export AS (
  SELECT
    ...
    tis.postcodes[1] as journey_start_postcode,
    tis.town as journey_start_town, -- TODO
    null as journey_start_epci, -- TODO
    cis.country as journey_start_country, -- TODO
    ...
    tie.postcodes[1] as journey_end_postcode, -- TODO
    cie.town as journey_end_town,-- TODO
    null as journey_end_epci,  -- TODO
    cie.country as journey_end_country, -- TODO
  ...
  JOIN territory.territories_view AS tis ON tis._id = cpp.start_territory_id
  JOIN territory.territories_view AS tie ON tie._id = cpp.start_territory_id
