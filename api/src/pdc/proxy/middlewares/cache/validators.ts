import {
  CacheValidatorParams,
  CacheValidatorResponse,
  HttpVerb,
} from "./types.ts";
...
const validators = [
  ...
  async function noStoreHeader(
    { req }: CacheValidatorParams,
  ): Promise<Partial<CacheValidatorResponse>> {
...
export async function validate(
  params: CacheValidatorParams,
): Promise<CacheValidatorResponse> {
  let isValid = true;
