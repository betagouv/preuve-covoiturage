...
export class ValidatorExtension extends ValidatorParentExtension {
  async init(serviceContainer: ServiceContainerInterface): Promise<void> {
    ...
    validator.registerCustomKeyword({
      name: "bic",
      type: "format",
      definition: bicCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "country",
      type: "format",
      definition: countryCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "department",
      type: "format",
      definition: departmentCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "euvat",
      type: "format",
      definition: euVatCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "iban",
      type: "format",
      definition: ibanCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "insee",
      type: "format",
      definition: inseeCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "naf",
      type: "format",
      definition: nafCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "nic",
      type: "format",
      definition: nicCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "objectid",
      type: "format",
      definition: objectidCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "phone",
      type: "format",
      definition: phoneCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "phonetrunc",
      type: "format",
      definition: phonetruncCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "postcode",
      type: "format",
      definition: postcodeCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "rna",
      type: "format",
      definition: rnaCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "siren",
      type: "format",
      definition: sirenCustomFormat,
    });
    validator.registerCustomKeyword({
      name: "siret",
      type: "format",
      definition: siretCustomFormat,
    });

    // register keywords (compile)
    validator.registerCustomKeyword({
      type: "keyword",
      definition: coordinatesKeyword,
    });
