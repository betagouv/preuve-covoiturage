...
import {
  RouteNormalizerProviderInterface,
  RouteParamsInterface,
  RouteResultInterface,
} from "../interfaces/index.ts";

@provider()
export class RouteNormalizerProvider
  implements RouteNormalizerProviderInterface {
  constructor(private geoProvider: GeoProviderInterfaceResolver) {}

  public async handle(
    payload: RouteParamsInterface,
  ): Promise<RouteResultInterface> {
