...
beforeEach((t) => {
  ...
  t.context.happenMarkdownDescription = new BuildResourceDescription(
    t.context.tripRepositoryProvider,
  );
  t.context.tripRepositoryProviderStub = sinon.stub(
    t.context.tripRepositoryProvider,
    "searchCount",
  );
});
...
it("BuildResourceDescription: should happen description to existing one", async (t) => {
  ...
  sinon.assert.calledWithMatch(
    t.context.tripRepositoryProviderStub.firstCall,
    t.context.tripSearchQueryParams,
  );
  ...
  sinon.assert.calledWithMatch(
    t.context.tripRepositoryProviderStub.secondCall,
