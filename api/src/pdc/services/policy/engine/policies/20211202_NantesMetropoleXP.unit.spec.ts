...
import { NantesMetropoleXPCovoitan2021 as Handler } from "./20211202_NantesMetropoleXP";
...
test(
  ...
  process,
  {
    ...
    carpool: [
      {
        distance: 5_000,
        passenger_identity_key: "11",
        driver_identity_key: "21",
        operator_trip_id: "1",
      },
      {
        distance: 5_000,
        passenger_identity_key: "11",
        driver_identity_key: "22",
        operator_trip_id: "2",
      },
      {
        distance: 5_000,
        passenger_identity_key: "11",
        driver_identity_key: "23",
        operator_trip_id: "3",
      },
      {
        distance: 5_000,
        passenger_identity_key: "11",
        driver_identity_key: "24",
        operator_trip_id: "4",
      },
      {
        distance: 5_000,
        passenger_identity_key: "11",
        driver_identity_key: "25",
        operator_trip_id: "5",
      },
      {
        distance: 5_000,
        passenger_identity_key: "11",
        driver_identity_key: "26",
        operator_trip_id: "6",
      },
    ],
    meta: [],
...
test(
  ...
  process,
  {
    ...
    carpool: [
      ...
      {
        distance: 5_000,
        passenger_identity_key: "13",
        driver_identity_key: "23",
        operator_trip_id: "1",
      },
      {
        distance: 5_000,
        passenger_identity_key: "14",
        driver_identity_key: "24",
        operator_trip_id: "1",
      },
    ],
