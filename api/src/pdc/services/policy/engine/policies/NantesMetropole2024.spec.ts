...
test(
  ...
  process,
  {
    policy: { handler: Handler.id },
    carpool: [
      { distance: 6_000, driver_identity_uuid: 'reg', datetime: new Date('2024-04-15') },
      { distance: 6_000, driver_identity_uuid: 'boo', datetime: new Date('2024-04-16') },
      { distance: 11_000, driver_identity_uuid: 'reg', datetime: new Date('2024-04-15') },
      { distance: 11_000, driver_identity_uuid: 'boo', datetime: new Date('2024-04-16') },
      { distance: 17_000, driver_identity_uuid: 'reg', datetime: new Date('2024-04-15') },
      { distance: 17_000, driver_identity_uuid: 'boo', datetime: new Date('2024-04-16') },
      { distance: 30_000, driver_identity_uuid: 'reg', datetime: new Date('2024-04-15') },
      { distance: 30_000, driver_identity_uuid: 'boo', datetime: new Date('2024-04-16') },
      { distance: 75_000, driver_identity_uuid: 'reg', datetime: new Date('2024-04-15') },
      { distance: 75_000, driver_identity_uuid: 'boo', datetime: new Date('2024-04-16') },
    ],
  },
  {
