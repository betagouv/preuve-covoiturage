...
export const GrandChatellerault2024: PolicyHandlerStaticInterface = class extends AbstractPolicyHandler implements PolicyHandlerInterface {
  ...
  constructor(public max_amount: number) {
    super();
    this.limits = [
      ['24338FBE-6E41-4C7D-B3FA-969EF0CB3789', this.max_amount, watchForGlobalMaxAmount],
      ['36089A82-4F5D-4AB0-809B-CDB1E41330D9', 6, watchForPersonMaxTripByDay, LimitTargetEnum.Driver],
      ['456D6AC1-DCE9-403A-876E-91E3B2E80A80', 2, watchForPersonMaxTripByDay, LimitTargetEnum.Passenger],
      ['71390F62-7377-427B-9F26-155F2225CDEF', 120_00, watchForPersonMaxAmountByMonth, LimitTargetEnum.Driver],
    ];
  }
  ...
  protected processExclusion(ctx: StatelessContextInterface, log?: TestingLogFn) {
    ...
    if (!startsAt(ctx, { aom: ['248600413'] }) && !endsAt(ctx, { aom: ['248600413'] })) {
    ...
    if (startsAt(ctx, { aom: aomToExclude }) || endsAt(ctx, { aom: aomToExclude })) {
      throw new NotEligibleTargetException();
    }
  }
