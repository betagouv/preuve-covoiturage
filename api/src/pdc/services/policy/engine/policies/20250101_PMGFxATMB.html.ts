export const description = `<div _ngcontent-fyn-c231="" id="summary" class="campaignSummaryText-content-text">
  ...
  <p>Cette campagne est limitée à <b>146 558,00 €</b>.</p>

  <p><strong>Règles applicables avant le 21/04/2025</strong></p>
  ...
  <!-- ------------------------------------------------------------------------------------ -->
  <p><strong>Règles applicables après le 21/04/2025</strong></p>
  <!-- ------------------------------------------------------------------------------------ -->
  ...
  <ul>
    <li><b>50€ maximum par conducteur par mois.</b></li>
  </ul>
