...
import { handlerConfig, ParamsInterface, ResultInterface } from "../contracts/syncIncentiveSum.contract.ts";
import { alias } from "../contracts/syncIncentiveSum.schema.ts";
