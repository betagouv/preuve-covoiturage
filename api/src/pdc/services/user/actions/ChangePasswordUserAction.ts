...
import { handlerConfig, ParamsInterface, ResultInterface } from "../contracts/changePassword.contract.ts";
import { alias } from "../contracts/changePassword.schema.ts";
...
export class ChangePasswordUserAction extends AbstractAction {
  ...
  public async handle(
    ...
    return this.authRepository.updatePasswordById(
      params._id,
      params.new_password,
    );
  }
