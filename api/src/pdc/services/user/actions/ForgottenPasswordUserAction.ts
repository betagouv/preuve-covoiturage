...
import { handlerConfig, ParamsInterface, ResultInterface } from "../contracts/forgottenPassword.contract.ts";
import { alias } from "../contracts/forgottenPassword.schema.ts";
