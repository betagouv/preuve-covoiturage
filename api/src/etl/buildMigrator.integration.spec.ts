...
describe.skip("Build Migrator", () => {
  ...
  it("should create com_evolution table", async () => {
  ...
  it("should do migration InseeMvtcom2021", async () => {
    await migrator.process(InseeMvtcom2021, new MemoryStateManager());
    const count = await connection.query(
  ...
  it("should do migration InseeMvtcom2022", async () => {
    await migrator.process(InseeMvtcom2022, new MemoryStateManager());
    const count = await connection.query(
  ...
  it("should do migration InseeMvtcom2023", async () => {
    await migrator.process(InseeMvtcom2023, new MemoryStateManager());
    const count = await connection.query(
  ...
  it("should create perimeters table", async () => {
    await migrator.process(CreateGeoTable, new MemoryStateManager());
    const count = await connection.query(
  ...
  it("should do migration IgnAe2019", async () => {
    await migrator.process(IgnAe2019, new MemoryStateManager());
  ...
  it("should do migration IgnAe2020", async () => {
    await migrator.process(IgnAe2020, new MemoryStateManager());
    const first = await connection.query(
  ...
  it("should do migration IgnAe2021", async () => {
    await migrator.process(IgnAe2021, new MemoryStateManager());
    const first = await connection.query(
  ...
  it("should do migration IgnAe2022", async () => {
    await migrator.process(IgnAe2022, new MemoryStateManager());
    const first = await connection.query(
  ...
  it("should do migration IgnAe2023", async () => {
    await migrator.process(IgnAe2023, new MemoryStateManager());
    const first = await connection.query(
  ...
  it("should do migration EurostatCountries2020", async () => {
    await migrator.process(
  ...
  it("should do migration EurostatSimplifiedCountries2020", async () => {
    await migrator.process(
  ...
  it("should do migration InseePays2021", async () => {
    await migrator.process(InseePays2021, new MemoryStateManager());
    const count = await connection.query(
  ...
  it("should do migration InseePays2022", async () => {
    await migrator.process(InseePays2022, new MemoryStateManager());
    const count = await connection.query(
  ...
  it("should do migration InseePays2023", async () => {
    await migrator.process(InseePays2023, new MemoryStateManager());
    const count = await connection.query(
      `SELECT count(distinct country) FROM public.perimeters 
  where year = 2023`,
    );
  ...
  it("should do migration Inseecom2021", async () => {
    await migrator.process(InseeCom2021, new MemoryStateManager());
    const first = await connection.query(
  ...
  it("should do migration Inseecom2022", async () => {
    await migrator.process(InseeCom2022, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where arr='75101' 
  ...
  it("should do migration Inseecom2023", async () => {
    await migrator.process(InseeCom2023, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where arr='75101' 
  ...
  it("should do migration InseePerim2019", async () => {
    await migrator.process(InseePerim2019, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2019 order by arr asc limit 1`,
    );
  ...
  it("should do migration InseePerim2020", async () => {
    await migrator.process(InseePerim2020, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2020 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].dep, "01");
  ...
  it("should do migration InseePerim2021", async () => {
    await migrator.process(InseePerim2021, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2021 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].dep, "01");
  ...
  it("should do migration InseePerim2022", async () => {
    await migrator.process(InseePerim2022, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2022 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].dep, "01");
  ...
  it("should do migration InseePerim2023", async () => {
    await migrator.process(InseePerim2023, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2023 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].dep, "01");
  ...
  it("should do migration InseeDep2021", async () => {
    await migrator.process(InseeDep2021, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2021 order by arr asc limit 1`,
    );
  ...
  it("should do migration InseeDep2022", async () => {
    await migrator.process(InseeDep2022, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2022 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].l_dep, "Ain");
  ...
  it("should do migration InseeDep2023", async () => {
    await migrator.process(InseeDep2023, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2023 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].l_dep, "Ain");
  ...
  it("should do migration InseeReg2021", async () => {
    await migrator.process(InseeReg2021, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2021 order by arr asc limit 1`,
    );
  ...
  it("should do migration InseeReg2022", async () => {
    await migrator.process(InseeReg2022, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2022 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].l_reg, "Auvergne-Rhône-Alpes");
  ...
  it("should do migration InseeReg2023", async () => {
    await migrator.process(InseeReg2023, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2023 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].l_reg, "Auvergne-Rhône-Alpes");
  ...
  it("should do migration CeremaAom2019", async () => {
    await migrator.process(CeremaAom2019, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2019 order by arr asc limit 1`,
    );
  ...
  it("should do migration CeremaAom2020", async () => {
    await migrator.process(CeremaAom2020, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2020 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].aom, null);
  ...
  it("should do migration CeremaAom2021", async () => {
    await migrator.process(CeremaAom2021, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2021 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].aom, null);
  ...
  it("should do migration CeremaAom2022", async () => {
    await migrator.process(CeremaAom2022, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2022 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].aom, null);
  ...
  it("should do migration CeremaAom2023", async () => {
    await migrator.process(CeremaAom2023, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2023 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].aom, null);
  ...
  it("should do migration DgclBanatic2021", async () => {
    await migrator.process(DgclBanatic2021, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2021 order by arr asc limit 1`,
    );
  ...
  it("should do migration DgclBanatic2022", async () => {
    await migrator.process(DgclBanatic2022, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2022 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].aom, "200053767");
  ...
  it("should do migration DgclBanatic2023", async () => {
    await migrator.process(DgclBanatic2023, new MemoryStateManager());
    const first = await connection.query(
      `SELECT * FROM perimeters where year = 2023 order by arr asc limit 1`,
    );
    assertEquals(first.rows[0].aom, "200053767");
