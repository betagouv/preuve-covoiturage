...
DO $$
  BEGIN
    BEGIN
      ALTER TABLE trip.list ADD COLUMN operator_journey_id int;
    EXCEPTION
      WHEN duplicate_column THEN RAISE NOTICE 'column operator_journey_id already exists on trip.list';
    END;
  END;
$$;
...
DO $$
  BEGIN
    BEGIN
      ALTER TABLE trip.list ADD COLUMN operator_passenger_id int;
    EXCEPTION
      WHEN duplicate_column THEN RAISE NOTICE 'column operator_passenger_id already exists on trip.list';
    END;
  END;
$$;
...
DO $$
  BEGIN
    BEGIN
      ALTER TABLE trip.list ADD COLUMN operator_driver_id int;
    EXCEPTION
      WHEN duplicate_column THEN RAISE NOTICE 'column operator_driver_id already exists on trip.list';
    END;
  END;
$$;

-- TODO: missing update trip.list 
-- UPDATE trip.list
