...
const identity = require('../../shared/entities/schemas/identity');
const position = require('../../shared/entities/schemas/position');
const rank = require('../../shared/entities/schemas/rank');
